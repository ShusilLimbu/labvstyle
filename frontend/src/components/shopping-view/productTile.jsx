    ...
    <div onClick={()=>handleGetProductDetails(product?._id)}>
        <div className='relative'>
            ...
            />
            {
                ...
                <Badge className='absolute top-2 left-2 bg-red-500 hover:bg-red-600'>`Only Rs.{product?.totalStock} in Stock`</Badge> :
                product?.salePrice > 0 ?
                <Badge className='absolute top-2 left-2 bg-red-500 hover:bg-red-600'>Offer</Badge> : null
            }
        </div>
