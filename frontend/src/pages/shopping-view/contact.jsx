  ...
  return (
    <div className = 'flex flex-col min-h-screen'>
      <div className = 'flex flex-col relative w-[640px] h-[520px] md:w-full md:h-[600px] overflow-hidden bg-slate-200'>
       ...
       <span>Whatsapp: <b>+977 9842903170</b></span><br/>
       <span>Facebook:<u><b><a href='https://www.facebook.com/shusil.limbu.2025/'> LabVStyle</a></b></u></span><br/>
       <span>Instagram:<u><b><a href='https://www.facebook.com/shusil.limbu.2025/'> labvstyle</a></b></u></span>
       </p>
